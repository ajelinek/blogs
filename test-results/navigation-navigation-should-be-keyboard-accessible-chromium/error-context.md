...
- Name: navigation should be keyboard accessible
- Location: /Users/ajelinek/code/blogs/tests/navigation.spec.ts:36:1
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Home' })
    ...
    at /Users/ajelinek/code/blogs/tests/navigation.spec.ts:39:44
```
