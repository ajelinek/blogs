...
- Name: responsive layout shows navigation on mobile
- Location: /Users/ajelinek/code/blogs/tests/navigation.spec.ts:48:1
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Home' })
    ...
    at /Users/ajelinek/code/blogs/tests/navigation.spec.ts:51:44
```
